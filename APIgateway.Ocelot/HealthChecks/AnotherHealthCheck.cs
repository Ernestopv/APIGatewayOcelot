// //
// <copyright file="AnotherHealthCheck.cs" company="The AA(Ireland) Limited">
...
namespace APIgateway.Ocelot.HealthChecks
{
    public class AnotherHealthCheck : IHealthCheck
    {
        ...
        /// <returns>
        /// A <see cref="Task" /> that completes when the health check has finished, yielding the
